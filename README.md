...
- [0n1x](https://onyx-actions.onrender.com) - Neutral verify-before-pay MCP: signed PROCEED/REVIEW/HOLD merchant, price & counterparty checks an agent calls before it pays. x402 on Base, every result Ed25519-signed and offline-verifiable; free consumer check at /check.
